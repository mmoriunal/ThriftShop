...
class Prenda implements Comparable<Prenda> {
    ...
    public Prenda(int id, String nombre, String color, char talla, int id_vendedor, int precio, String fotoPath) {
        this.id = id;
        this.nombre = nombre;
        this.color = color;
        this.talla = talla;
